  ...
  return (
    ...
    >
      <CardContent className="w-full h-[13rem] p-0 mb-2 relative">
        ...
        />
        <span className="absolute bg-black/80 text-xs px-1 rounded-sm font-semibold bottom-1.5 right-3 text-white py-0.5">{duration}</span>
      </CardContent>
      <CardFooter className="flex items-start justify-between p-2">
        ...
        <Avatar className='active:scale-75 transition-all duration-300'>
          ...
          <div>
            <h3 className="text-base leading-[1.25rem] overflow-hidden overflow-ellipsis line-clamp-2 font-semibold text-gray-700 dark:text-white w-[90%] mb-1.5">
              {title}
            </h3>
