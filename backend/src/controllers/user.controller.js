...
const refreshAccessToken = asyncHandler(async (req, res) => {
    const incomingRefreshToken = req.cookies.refreshToken || req.body.refreshToken //access refresh token from mobile devices
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    await deleteFromCloudinary(req.user.avatar_id)
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    await deleteFromCloudinary(req.user.coverImage_id)
